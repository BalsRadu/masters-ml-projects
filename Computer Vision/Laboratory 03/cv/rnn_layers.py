...
def lstm_step_forward(x, prev_h, prev_c, Wx, Wh, b):
    ...
    cache = (x, Wx, Wh, a, i, f, o, g, prev_c, prev_h, next_c, next_h)
...
def lstm_step_backward(dnext_h, dnext_c, cache):
    ...
    x, Wx, Wh, a, i, f, o, g, prev_c, prev_h, next_c, next_h = cache
...
def lstm_forward(x, h0, Wx, Wh, b):
    ...
    for t in range(T):
        prev_h, prev_c, cache_t = lstm_step_forward(
